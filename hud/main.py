...
from system.agents.browser_agent import BrowserAgent
from system.cache import metrics_cache
from system.security_log import log_auth, log_rate_limit, log_threat, log_input_violation
from system.plugin_manager import plugin_manager
from system.monitor import monitor as _monitor
from system.core   import ReasoningCore
from system.router import Router
from voice         import listener
from voice.silero_speaker import speak as _speak_raw
from voice.silero_speaker import stop  as _stop_raw
...
class JarvisHandler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):  # noqa: N802
        ...
        if path == "/ask":
            ...
            try:
                from system.memory import log_interaction
    ...
    def _handle_mac_get(self, qs):
        from system.mac_control import get_volume
    ...
    def _handle_mac_post(self, body):
        from system import mac_control as mc
    ...
    def _handle_browse(self, body: dict):
        from system.agents.browser_agent import (
...
def main():
    ...
    # Greeting on startup
    try:
        from system.proactive import get_time_aware_greeting
    ...
    def _proactive_loop():
        ...
        while True:
            _t.sleep(1800)
            try:
                from system.proactive import get_proactive_suggestion
                from system.agents.morning_agent import MorningAgent as _MA
    ...
    from system.agents.ollama_agent import ensure_running as _ollama_ensure
