...
ВИМОГИ ДО ОБСЯГУ:
- Мінімум 800 слів
- Розкрий тему глибоко та практично
- Уникай повторень та загальних фраз
...
### Основний матеріал
[контент відповідно до рівня — мінімум 400 слів]

### Практичні приклади для LK Energy
[2-3 реальних кейса з практики монтажу/продажу/інжинірингу СЕС.
Кожен кейс: ситуація → дія → результат. Мінімум 200 слів]

### Типові помилки
[3-5 конкретних помилок на цьому рівні.
Формат кожної: помилка → чому це проблема → як правильно. Мінімум 150 слів]

### Корисні посилання
[Якщо в матеріалі є посилання, нормативи, документи або назви виробників — навести тут.
Формат: - Назва: опис. Якщо посилань немає — пропустити цей розділ.]
...
Мова: українська. Без води. Практично.
""",
}
